...
class Hotel(db.Model):
    ...
    amenities = db.relationship(
        'Amenity', secondary=amenity_hotel, backref='hotel')
    extra_feature = db.relationship(
        'extra_feature', secondary=hotel_extra_feature, backref='hotel')
...
class Extrafeature(db.Model):
    ...
    def __repr__(self) -> str:
        return f'Extrafeature>>>{self.comp_key}'
